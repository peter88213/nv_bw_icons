...
Download the latest release [nv_bw_icons_v0.2.0.pyz](https://github.com/peter88213/nv_bw_icons/raw/main/dist/nv_bw_icons_v0.2.0.pyz)

- Launch *nv_bw_icons_v0.2.0.pyz* by double-clicking (Windows desktop),
- or execute `python nv_bw_icons_v0.2.0.pyz` (Windows), resp. `python3 nv_bw_icons_v0.2.0.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_bw_icons_v0.2.0.zip](https://github.com/peter88213/nv_bw_icons/raw/main/dist/nv_bw_icons_v0.2.0.zip)

- Extract the *nv_bw_icons_v0.2.0* folder from the downloaded zipfile "nv_bw_icons_v0.2.0.zip".
